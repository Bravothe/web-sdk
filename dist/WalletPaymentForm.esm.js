...
function EnterPasscode(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(Text$4, null, "Enter Passcode")), /*#__PURE__*/React.createElement(Input.Password, {
    value: passcode,
    onChange: onChange,
    placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022",
    maxLength: 6,
  ...
  }, "You are making a payment to ", /*#__PURE__*/React.createElement("b", null, d.merchantName || 'Unknown Merchant'), " and amount", ' ', /*#__PURE__*/React.createElement("b", null, currency, " ", total.toLocaleString()), " will be deducted off your wallet, including", ' ', /*#__PURE__*/React.createElement("b", null, (TAX_RATE * 100).toFixed(1), "% tax"), " (", currency, " ", tax.toFixed(0), ") and", ' ', /*#__PURE__*/React.createElement("b", null, (FEE_RATE * 100).toFixed(1), "% wallet fee"), " (", currency, " ", fee.toFixed(0), ").")), /*#__PURE__*/React.createElement(Button, {
    type: "primary",
    size: "large",
    shape: "round",
    block: true,
...
function PaymentFailedModal(_ref) {
  ...
  }, "We couldn\u2019t complete the payment. Please check your wallet for more details and try again."), /*#__PURE__*/React.createElement(Button, {
    type: "primary",
    danger: true,
    shape: "round",
    size: "middle",
...
function InsufficientFundsModal(_ref) {
  ...
  }, "The account did not have sufficient funds to cover the transaction amount at the time of the transaction"), /*#__PURE__*/React.createElement(Button, {
    type: "primary",
    shape: "round",
    size: "middle",
...
function WalletPaymentForm(_ref) {
  ...
  var renderInvalid = () => /*#__PURE__*/React.createElement(Modal, _extends({
    open: true,
    centered: true,
    footer: null,
    onCancel: closeAndReset,
    maskClosable: false
  }, modalMotion), /*#__PURE__*/React.createElement(Space, {
    direction: "vertical",
    align: "center",
    style: {
      width: '100%'

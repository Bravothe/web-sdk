...
import { Modal, Result as Result$1, Button, Typography, Space, Avatar, Spin, Descriptions, Input } from 'antd';
...
function PaymentSuccessModal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    zIndex: zIndex,
    maskClosable: false
  }, /*#__PURE__*/React.createElement(Result$1, {
    status: "success",
    icon: /*#__PURE__*/React.createElement(CheckCircleTwoTone, {
      twoToneColor: "#52c41a"
    }),
...
function PaymentFailedModal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    status: "error",
    icon: /*#__PURE__*/React.createElement(CloseCircleTwoTone, {
      twoToneColor: "#ff4d4f"
    }),
...
function InsufficientFundsModal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    status: "warning",
    icon: /*#__PURE__*/React.createElement(ExclamationCircleTwoTone, {
      twoToneColor: "#faad14"
    }),
...
function WalletPaymentForm(_ref) {
  ...
  var [txnId] = useState(() => "W-".concat(Math.floor(Math.random() * 1000000000)));
  ...
  var details = useMemo(() => buildTxnDetails(amount, txnId, type, particulars, currency, merchantName, merchantLogo), [amount, txnId, type, particulars, currency, merchantName, merchantLogo]);
  var handleConfirm = () => {
  ...
  var renderLoading = () => /*#__PURE__*/React.createElement(Modal, {
    open: true,
    centered: true,
    footer: null,
    closable: false,
  ...
  }, "EVzone Pay"), /*#__PURE__*/React.createElement(Spin, {
  ...
  var renderInvalid = () => /*#__PURE__*/React.createElement(Modal, {
    ...
    type: "secondary"
  }, "The transaction amount is missing or invalid."), /*#__PURE__*/React.createElement(Button, {
    type: "primary",
    onClick: closeAndReset
  }, "Close")));
  var renderSummary = () => /*#__PURE__*/React.createElement(Modal, {
    open: true,
    centered: true,
    zIndex: zIndex,
    maskClosable: false,
    title: /*#__PURE__*/React.createElement(Space, {
      align: "center"
    }, details.merchantLogo ? /*#__PURE__*/React.createElement(Avatar, {
      src: details.merchantLogo
    }) : /*#__PURE__*/React.createElement(Avatar, null, (details.merchantName || 'E')[0]), /*#__PURE__*/React.createElement("span", null, details.merchantName)),
    onCancel: closeAndReset,
  ...
  }, details.billedCurrency, " ", Number(details.totalBilling).toFixed(2)), /*#__PURE__*/React.createElement(Descriptions, {
    bordered: true,
    size: "small",
    column: 1,
    items: [{
  ...
  var renderPasscode = () => /*#__PURE__*/React.createElement(Modal, {
    open: true,
    centered: true,
    zIndex: zIndex,
    maskClosable: false,
  ...
  }, details.billedCurrency, " ", Number(details.totalBilling).toFixed(2))), /*#__PURE__*/React.createElement(Input.Password, {
    value: passcode,
